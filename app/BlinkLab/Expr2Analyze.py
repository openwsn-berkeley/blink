...
#============================ visualizing data ======================================
    ...
    plt.suptitle('Distribution of RSSI values for blink mote at the room A102')
    ...
    for loc in real_expr_loc:
        plt.suptitle('Distribution of RSSI values for blink mote at the room {}'.format(loc))
